...
// Lazy load other routes to reduce initial bundle size and improve Time to Interactive.
// This optimization avoids loading the entire app bundle upfront.
// Expected performance impact: Reduces initial JS payload by roughly 40-60%.
...
// Fallback component wrapped in Layout to prevent header/footer flickering during load
const Fallback = () => (
  <Layout isStatic={true}>
    <div className="pt-40 p-10 text-center text-primary h-[80vh] font-display text-4xl">
      Laden...
    </div>
  </Layout>
);
