...
// Pages - dynamically imported for code splitting
// Reduces initial bundle size by loading pages only when requested
    ...
    <Router basename="/kirschbaum1site">
      <Suspense fallback={
        <Layout isStatic={true}>
          <div className="pt-40 p-10 text-center text-primary h-[80vh] flex items-center justify-center">
