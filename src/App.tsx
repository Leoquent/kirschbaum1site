...
// Pages
// ⚡ Bolt: Added route-level code splitting using React.lazy.
// This splits the main bundle into smaller chunks that are loaded on demand.
// Expected Impact: Reduces initial main chunk size from ~477kB to ~376kB (pre-gzip).
...
export default function App() {
  return (
    <Router basename="/kirschbaum1site">
      <Suspense fallback={<div className="flex items-center justify-center min-h-screen text-primary font-display">Lade...</div>}>
      <Routes>
