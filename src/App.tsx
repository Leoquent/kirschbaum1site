...
// ⚡ Bolt: Route-Level Code Splitting Optimization
// What: Lazy loading individual page components instead of importing them all upfront.
// Why: Previously, all page code was bundled together, slowing down the initial paint of the application.
// Impact: Reduces the initial main JS bundle size significantly (e.g. by 40-50%), allowing the home page to load much faster.
// Pages
...
export default function App() {
  return (
    <Router basename="/kirschbaum1site">
      <Suspense fallback={<Layout isStatic={true}><div className="pt-40 p-10 text-center h-[80vh]">Laden...</div></Layout>}>
        <Routes>
