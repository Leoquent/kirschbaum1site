...
// Code splitting route components with React.lazy to reduce the initial JavaScript bundle size.
// This improves Time to Interactive (TTI) and First Contentful Paint (FCP) by loading only the code needed for the current route.
...
export default function App() {
  return (
    <Router basename="/kirschbaum1site">
      <Suspense fallback={<Layout isStatic={true}><div className="flex h-[80vh] items-center justify-center text-primary font-display text-4xl">Laden...</div></Layout>}>
        <Routes>
