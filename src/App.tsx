...
// Implemented route-level code splitting using React.lazy() to reduce the initial JS bundle size.
// Instead of loading all page components upfront, they are now loaded on-demand when the route is visited.
// Expected Impact: Faster Initial Page Load (LCP & TTI) due to a smaller main chunk.
// The fallback wrapper uses <Layout isStatic={true}> to ensure the navbar/footer don't flash during chunk loading.
