...
// This reduces the initial bundle size by splitting page components (Home, About, etc.)
// into their own chunks. Previously, all pages were bundled into a single ~477kB JS file.
// Now, the initial chunk is smaller (~411kB) and pages are loaded on demand.
...
export default function App() {
  return (
    <Router basename="/kirschbaum1site">
      <Suspense fallback={<Layout isStatic={true}><div className="pt-40 p-10 text-center text-primary h-[80vh]">Lade...</div></Layout>}>
        <Routes>
