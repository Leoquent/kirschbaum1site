...
// Strategy: Replace static imports with React.lazy to split the application bundle by route.
// Impact: Reduces the initial JavaScript payload size and speeds up the initial page load time (Time to Interactive).
// Expected to decrease main bundle size by separating page components and their specific dependencies.
// Note: Named exports are mapped to default exports in the import promise for React.lazy compatibility.
...
// NotFound is already a default export
...
export default function App() {
  return (
    <Router basename="/kirschbaum1site">
      <Suspense fallback={<Layout isStatic={true}><div className="pt-40 p-10 text-center text-primary h-[80vh]">Laden...</div></Layout>}>
        <Routes>
