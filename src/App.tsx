...
// ⚡ Bolt Optimization: Lazy load non-critical routes to reduce the initial JavaScript bundle size.
// This significantly improves the initial load time (LCP) for the Home page.
// The named exports are mapped to default exports required by React.lazy.
