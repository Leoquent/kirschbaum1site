...
// Wrapping route components in React.lazy avoids loading the entire app bundle upfront.
// This significantly reduces the initial load time and JS evaluation cost, especially
// since pages like Home and References contain large amounts of markup and text.
