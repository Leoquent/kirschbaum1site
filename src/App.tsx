 ...
 * - Replaced static imports with React.lazy() to reduce the initial main bundle size.
 * - This delays loading of non-critical route chunks until they are visited, significantly improving the First Contentful Paint (FCP) and Time to Interactive (TTI).
 * - Mapped named exports to default exports explicitly since React.lazy requires a default export.
 * - Created LoadingFallback wrapped in <Layout isStatic={true}> to prevent the header/footer from flashing out of existence while chunks load.
 */
...
const NotFound = React.lazy(() => import('./NotFound')); // NotFound uses default export

// Loading Fallback Component
const LoadingFallback = () => (
  <Layout isStatic={true}>
    <div className="pt-40 p-10 flex items-center justify-center h-[80vh] text-primary">
