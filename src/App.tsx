...
export default function App() {
  return (
    <Router basename="/kirschbaum1site">
      {/* Suspense wrapper added for lazy loading with minimal fallback */}
      <Suspense fallback={<div className="min-h-screen bg-white flex items-center justify-center"><div className="w-8 h-8 border-4 border-primary border-t-transparent rounded-full animate-spin"></div></div>}>
        <Routes>
