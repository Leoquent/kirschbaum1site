...
// ⚡ Bolt: Implement Code Splitting for Route Components
// What: Replaced static imports with React.lazy() for all major page components.
// Why: Reduces the initial bundle size by splitting route components into separate chunks, improving initial load time.
