...
// Pages
// Optimization: Keep Home imported statically for fast initial load, code-split the rest.
import { Home } from './pages/Home';

// Optimization: Code-split routes to reduce initial JS bundle size and improve load time.
...
export default function App() {
  return (
    <Router basename="/kirschbaum1site">
      <Suspense fallback={<Layout isStatic={true}><div className="flex items-center justify-center h-screen"><div className="w-8 h-8 border-4 border-primary border-t-transparent rounded-full animate-spin"></div></div></Layout>}>
        <Routes>
