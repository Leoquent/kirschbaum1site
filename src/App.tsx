...
// This reduces the initial main bundle size (from ~377kB to ~140kB for chunks)
// by deferring the loading of page components until they are actually visited.
// Note: Named exports are mapped to default exports to be compatible with React.lazy.
...
const SuspenseFallback = () => (
    <Layout isStatic={true}>
        <div className="pt-40 p-10 flex items-center justify-center h-[80vh]">
